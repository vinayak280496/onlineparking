...
<jsp:include page="sidebar.jsp"></jsp:include>
            <div id="page-content">
				...
				<div align="right"><a href="../User/Service_station_details_form.jsp" title="Add New">Add New Record  <img height="50px" width="50px" src="abc.png"/></a></div></h4>
...
<thead>
  <tr>
    ...
    <td><a onClick="return confirm('Do You Really Want To Delete....?')" href="Service_station_details_delete.jsp?delete=<%=rs.getInt("ser_stan_id")%>"><img height="30px" width="30px" src="delete.png"/></td>
    <td><a href="Service_station_details_edit.jsp?edit=<%=rs.getInt("ser_stan_id")%>" onClick="return confirm('Do You Really Want To Edit....?')"><img height="30px" width="30px" src="photo.jpg"/></a></td>
  </tr>
  <%
  }
  %>
