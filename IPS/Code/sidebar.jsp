                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="side-tab-menu">
                                ...
                                <nav id="primary-nav">
                                    <ul>
                                        <li>
                                            <a href="home.php"><i class="glyphicon-display"></i>Dashboard</a>
                                        </li>
                                        <li>
                                            <a href="event_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Events</a>
                                        </li>
										 <li>
                                            <a href="reminder_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Reminders</a>
                                        </li>
										<li>
                                            <a href="notification_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Notifications</a>
                                        </li>
										  <li>
                                            <a href="expense_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Expenses</a>
                                        </li>
										<li>
                                            <a href="expense_details_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Expense Details</a>
                                        </li>
										<li>
                                            <a href="notes_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Notes</a>
                                        </li>
										<li>
                                            <a href="faculty_view.php" class="menu-link"><i class="glyphicon-vector_path_curve"></i>Faculty</a>
                                        </li>
