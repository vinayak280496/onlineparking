...
<jsp:include page="sidebar.jsp"></jsp:include>
            ...
            <div id="page-content">
                           ...
                           <!-- With Borders Style -->
                <h4 class="page-header">Parking Chart
...
%>
  ...
  <tr>
    ...
    <td><a href="Parking_Chart_delete.jsp?delete=<%=rs.getInt("parcking_chart_id")%>" onClick="return confirm('Do You Really Want To Delete....?')">Delete</td>
    <td><a href="Parking_Chart_edit.jsp?edit=<%=rs.getInt("parcking_chart_id")%>" onClick="return confirm('Do You Really Want To Edit....?')">Edit</a></td>
  </tr>
