...
<jsp:include page="sidebar.jsp"></jsp:include>
            <div id="page-content">
				...
				<div align="right"><a href="../User/Parking_Rates_form.jsp" title="Add New">Add New Record</a></div></h4>
...
<thead>
  ...
  <thead>
    ...
    <td><a onClick="return confirm('Do You Really Want To Delete....?')" href="Parking_Rates_delete.jsp?delete=<%=rs.getInt("rate_id")%>">delete</a></td>
    <td><a href="Parking_Rates_edit.jsp?edit=<%=rs.getInt("rate_id")%>" onClick="return confirm('Do You Really Want To Edit....?')">Edit</a></td>
  </tr>
  <%
  }
  %>
